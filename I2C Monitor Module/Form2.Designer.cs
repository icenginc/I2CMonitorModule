namespace I2C_Monitor_Module
{
	partial class Form2
	{
		...
		private void InitializeComponent()
		{
			...
			// button_ok
			// 
			this.button_ok.Location = new System.Drawing.Point(228, 183);
			...
			// button_cancel
			// 
			this.button_cancel.Location = new System.Drawing.Point(319, 183);
			...
			this.label1.Text = "Enter Board SN #\'s:";
			// 
			// label2
			// 
			...
			this.label2.Text = "Enter Register Limits:";
			// 
			// address
			// 
